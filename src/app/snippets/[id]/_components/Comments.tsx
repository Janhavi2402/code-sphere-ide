...
// Define the Comment type with _creationTime
type CommentType = {
  _id: Id<"snippetComments">; // Use Id<"snippetComments"> for _id
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="space-y-6">
          {comments.map((comment: CommentType) => (
            <Comment
              key={comment._id} // Directly use _id as the key
              comment={comment}
              onDelete={handleDeleteComment}
              isDeleting={deletinCommentId === comment._id} // Compare directly with _id
